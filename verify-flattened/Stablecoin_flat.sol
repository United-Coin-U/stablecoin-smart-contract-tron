...
// File: contracts/RescuableToken.sol
...
abstract contract RescuableToken {
    ...
    function rescueTokens(
        ...
        // CRITICAL: Prevent owner from withdrawing the stablecoin itself
        // This protects user deposits
    ...
    /**
     * @dev Allow contract to receive TRX
     * Without this, the contract cannot receive direct TRX transfers
     */
    receive() external payable {
        // Allow receiving TRX
        // No logic needed, just accept it
    }
...
// File: node_modules/@openzeppelin/contracts/interfaces/IERC7913.sol
...
// File: node_modules/@openzeppelin/contracts/utils/Bytes.sol
...
// File: node_modules/@openzeppelin/contracts-upgradeable/utils/NoncesUpgradeable.sol
...
// File: node_modules/@openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC20PausableUpgradeable.sol
